...
public class Camera2BasicFragment extends Fragment
    ...
    private void classifyFrame() {
        ...
        //FIXME : compute position and conf of the boxes
        float[][] position = new float[100][4];
        float[] conf = new float[100];
        int number = classifier.classifyFrame(bitmap, textToShow, position, conf);

//        Paint mpaint = new Paint();
//        mpaint.setColor(Color.RED);
//        mpaint.setStyle(Paint.Style.STROKE);
//        Canvas canvas = surfaceHolder.lockCanvas();
//        canvas.drawRect(0, 50, 100, 100, mpaint);
//        surfaceHolder.unlockCanvasAndPost(canvas);


        //FIXME：draw rectangle
        ...
        for (int i = 0; i < number; i++) {
            canvas.drawRect(position[i][0], position[i][1], position[i][2], position[i][3], mpaint);
            canvas.drawText(String.valueOf(conf[i]), position[i][0], position[i][1], mpaint);
        }
        surfaceHolder.unlockCanvasAndPost(canvas);
